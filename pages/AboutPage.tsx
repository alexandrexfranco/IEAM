                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <motion.div className="text-center" variants={itemVariants}>
                            <img src="https://i.ibb.co/rTyf7jC/Pr-Presidente-Jo-o-Batista.png" alt="Pr. João Batista Ferreira dos Santos" className="w-48 h-48 rounded-full mx-auto mb-4 shadow-lg object-cover border-4 border-brand-gold/50" />
                            <h3 className="font-heading text-xl text-brand-gold font-bold">Pr. João Batista Ferreira dos Santos</h3>
                            <p className="text-brand-light/80">Pastor Presidente</p>
                        </motion.div>
                        {/* Pastor Card 2 */}
                        <motion.div className="text-center" variants={itemVariants}>
                            <img src="https://i.ibb.co/pr571xBg/Pra-Rosinea-Rocha-dos-Santos.png" alt="Pra. Rosinea Rocha dos Santos" className="w-48 h-48 rounded-full mx-auto mb-4 shadow-lg object-cover border-4 border-brand-gold/50" />
                            <h3 className="font-heading text-xl text-brand-gold font-bold">Pra. Rosinea Rocha dos Santos</h3>
                            <p className="text-brand-light/80">Pastora</p>
                        </motion.div>
                        {/* Pastor Card 3 */}
                        <motion.div className="text-center" variants={itemVariants}>
                            <img src="https://i.ibb.co/G3RV6b4j/Pr-Marcos-Getulio.png" alt="Pr. Marcos Getúlio Pivetta" className="w-48 h-48 rounded-full mx-auto mb-4 shadow-lg object-cover border-4 border-brand-gold/50" />
                            <h3 className="font-heading text-xl text-brand-gold font-bold">Pr. Marcos Getúlio Pivetta</h3>
                            <p className="text-brand-light/80">Pastor</p>
                        </motion.div>
                    </motion.div>
                </div>
            </section>
